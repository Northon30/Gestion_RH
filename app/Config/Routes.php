...
$routes->group('', ['filter' => 'auth'], function ($routes) {
    ...
    $routes->get('employe/export-excel',     'EmployeController::exportExcel');
    $routes->get('employe/export-csv',       'EmployeController::exportCsv');
    $routes->get('employe/modele',           'EmployeController::modele');
    $routes->post('employe/import',          'EmployeController::import');

    // ============================================================
    // CONGES
    // Workflow : Employé soumet → Chef approuve → RH valide
    // ============================================================
    ...
    // RH      → CRUD complet + inviter un employé
    // Chef    → create/store/edit/update/delete + inviter
    // Employé → voir + s'inscrire + accepter/refuser invitation
    // ============================================================
    ...
    // Invitation — RH et Chef
    $routes->post('formation/inviter/(:num)',              'FormationController::inviter/$1');
    // Inscription libre — Employé uniquement
    $routes->post('formation/s-inscrire/(:num)',           'FormationController::sInscrire/$1');
    $routes->post('formation/se-desinscrire/(:num)',       'FormationController::seDesinscrire/$1');
    // Réponse invitation — Employé uniquement
    $routes->post('formation/accepter-invitation/(:num)', 'FormationController::accepterInvitation/$1');
    $routes->post('formation/refuser-invitation/(:num)',  'FormationController::refuserInvitation/$1');
    // Confirmation compétences — Chef uniquement
    $routes->post('formation/confirmer-competences/(:num)','FormationController::confirmerCompetences/$1');
    ...
    // ============================================================
    // EVENEMENTS
    // RH      → CRUD complet + gérer participations tous profils
    // Chef    → voir + gérer participations de sa direction
    // Employé → voir + participer/se retirer soi-même
    // ============================================================
    ...
    $routes->post('evenement/ajouter-participant/(:num)',     'EvenementController::ajouterParticipant/$1');
    ...
    $routes->post('notifications/delete-toutes',   'NotificationController::deleteToutes');

    // ============================================================
    // PROFIL PERSONNEL — tous les profils
    // ============================================================
    $routes->get('profil',                         'ProfilUtilisateurController::index');
    $routes->get('profil/password',                'ProfilUtilisateurController::password');
    $routes->post('profil/password/update',        'ProfilUtilisateurController::updatePassword');

    // ============================================================
    // SOLDES CONGÉS — RH uniquement
    // ============================================================
    $routes->post('solde-conge/ajuster/(:num)',    'SoldeCongeController::ajuster/$1');
    $routes->post('solde-conge/initialiser-annee','SoldeCongeController::initialiserAnnee');
