...
<style>
    ...
    .source-opt.selected { border-color: var(--c-orange-border); background: var(--c-orange-pale); }
...
<div class="page-header">
    <div>
        <h1><i class="fas fa-pen me-2" style="color:#F5A623;"></i>Modifier la demande</h1>
