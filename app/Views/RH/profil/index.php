...
<style>
    ...
    .info-value-highlight { color: var(--c-orange); font-weight: 700; font-size: 0.85rem; }
...
<div class="page-header">
    <div>
        <h1><i class="fas fa-user-circle me-2" style="color:#F5A623;"></i>Mon profil</h1>
        <p>Vos informations personnelles et professionnelles</p>
    </div>
    <div style="display:flex;gap:8px;flex-wrap:wrap;">
        <a href="<?= base_url('employe/show/' . $emp['id_Emp']) ?>" class="btn-ghost">
            <i class="fas fa-id-card"></i> Ma fiche employé
        </a>
        <a href="<?= base_url('profil/password') ?>" class="btn-orange">
