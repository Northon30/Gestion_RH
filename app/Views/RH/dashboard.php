...
<style>
    ...
    .status-dot.approuve   { background: #90c97f; }
    .status-dot.rejete     { background: #ff6b7a; }
    ...
    <div class="col-xl-2 col-md-4 col-sm-6">
        <div class="stat-card c-red">
            ...
            <div class="stat-info">
                ...
                <div class="stat-sub down"><i class="fas fa-clock" style="font-size:0.6rem;"></i> À valider</div>
            </div>
        </div>
    </div>
    <div class="col-xl-2 col-md-4 col-sm-6">
...
<!-- Congés + Anniversaires + Alertes -->
<div class="row g-3 mb-4">

    <div class="col-xl-5">
        <div class="section-block">
            <div class="section-head">
                <h6><i class="fas fa-calendar-alt"></i> Congés en attente</h6>
                <a href="<?= base_url('conge') ?>" class="btn-outline-orange" style="padding:4px 12px;font-size:0.75rem;">
                    Voir tout
                </a>
            </div>
    ...
    <div class="col-xl-3">
        <div class="section-block">
            <div class="section-head">
                <h6><i class="fas fa-bell"></i> Alertes</h6>
            </div>
            <div class="p-3">
                <?php
                $hasAlerts = !empty($congesEnAttente)
                          || !empty($absencesEnCours)
                ...
                <?php if ($hasAlerts): ?>
                    ...
                    <div class="alert-item">
                        ...
                        <div class="alert-txt">
                            <p><?= count($congesEnAttente) ?> congé(s) en attente</p>
...
<!-- Mon espace personnel (RH est aussi employé) -->
    ...
    <div class="col-xl-5 col-md-6">
        <div class="section-block">
            <div class="section-head">
                ...
                <a href="<?= base_url('conge/create') ?>" class="btn-orange" style="padding:5px 12px;font-size:0.75rem;">
    ...
    <div class="col-xl-4">
        <div class="section-block">
            <div class="section-head">
                ...
                <a href="<?= base_url('absence/create') ?>" class="btn-outline-orange" style="padding:4px 12px;font-size:0.75rem;">
                    Déclarer
                </a>
            </div>
...
<script>
    ...
    new Chart(document.getElementById('chart-competences'), {
        ...
        data: {
            ...
            datasets: [{
                data: <?= json_encode(array_column($competencesParDirection, 'nb_competences')) ?>,
    ...
    new Chart(document.getElementById('chart-formations'), {
        ...
        data: {
            ...
            datasets: [{
                data: <?= json_encode(array_column($participationFormations, 'nb_inscrits')) ?>,
