...
<div class="page-header">
    <div>
        <h1><i class="fas fa-pen me-2" style="color:#F5A623;"></i>Modifier le type de congé</h1>
        <p><?= esc($type['Libelle_Tcg']) ?></p>
    </div>
    <a href="<?= base_url('parametres/type-conge/show/' . $type['id_Tcg']) ?>" class="btn-ghost">
    ...
    <div class="form-card-header">
        <div class="form-card-header-left">
            ...
            <div>
                ...
                <p class="form-card-subtitle">Type congé ID # <?= (int)$type['id_Tcg'] ?></p>
            </div>
        </div>
        <span class="badge-id"># <?= (int)$type['id_Tcg'] ?></span>
    </div>

    <form action="<?= base_url('parametres/type-conge/update/' . $type['id_Tcg']) ?>" method="POST">
        <?= csrf_field() ?>
        ...
        <div class="form-card-body">
            ...
            <div class="current-val">
                ...
                Valeur actuelle : <span><?= esc($type['Libelle_Tcg']) ?></span>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" name="Libelle_Tcg" id="f-libelle"
                       class="form-control" maxlength="100"
                       value="<?= old('Libelle_Tcg', esc($type['Libelle_Tcg'])) ?>"
