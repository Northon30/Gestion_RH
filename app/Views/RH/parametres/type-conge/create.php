...
<div class="page-header">
    <div>
        <h1><i class="fas fa-plus me-2" style="color:#F5A623;"></i>Nouveau type de congé</h1>
        <p>Ajouter un type de congé au référentiel</p>
    </div>
...
<div class="form-card">
    ...
    <form action="<?= base_url('parametres/type-conge/store') ?>" method="POST">
        <?= csrf_field() ?>
        ...
        <div class="form-card-body">
            <div class="form-group">
                ...
                <input type="text" name="Libelle_Tcg" id="f-libelle"
                       ...
                       placeholder="Ex : Congé annuel, Congé maladie, RTT..."
                       value="<?= old('Libelle_Tcg') ?>"
