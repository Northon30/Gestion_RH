...
<style>
    ...
    .char-counter {
        font-size:0.68rem; color:var(--c-muted); text-align:right;
    }
...
<div class="page-header">
    <div>
        <h1><i class="fas fa-pen me-2" style="color:#F5A623;"></i>Modifier le profil</h1>
        <p><?= esc($profil['Libelle_Pfl']) ?></p>
    </div>
    <a href="<?= base_url('parametres/profil/show/' . $profil['id_Pfl']) ?>" class="btn-ghost">
    ...
    <div class="form-card-header">
        <div class="form-card-header-left">
            ...
            <div>
                ...
                <p class="form-card-subtitle">Profil ID # <?= (int)$profil['id_Pfl'] ?></p>
            </div>
        </div>
        <span class="badge-id"># <?= (int)$profil['id_Pfl'] ?></span>
    </div>

    <form action="<?= base_url('parametres/profil/update/' . $profil['id_Pfl']) ?>" method="POST">
        <?= csrf_field() ?>
        ...
        <div class="form-card-body">
            ...
            <div class="current-val">
                ...
                Valeur actuelle : <span><?= esc($profil['Libelle_Pfl']) ?></span>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" name="Libelle_Pfl" id="f-libelle"
                       class="form-control" maxlength="100"
                       value="<?= old('Libelle_Pfl', esc($profil['Libelle_Pfl'])) ?>"
