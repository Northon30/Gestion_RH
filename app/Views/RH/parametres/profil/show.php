...
<style>
    ...
    .profil-hero-name { color:#fff; font-size:1rem; font-weight:800; }
    .profil-hero-id   { color:var(--c-orange); font-size:0.72rem; margin-top:2px; }
...
<div class="page-header">
    <div>
        <h1><i class="fas fa-id-badge me-2" style="color:#F5A623;"></i><?= esc($profil['Libelle_Pfl']) ?></h1>
        <p><?= $nbEmployes ?> employé(s) associé(s)</p>
    </div>
    <div style="display:flex;gap:8px;flex-wrap:wrap;">
        <a href="<?= base_url('parametres/profil') ?>" class="btn-ghost">
            <i class="fas fa-arrow-left"></i> Retour
        </a>
        <a href="<?= base_url('parametres/profil/edit/' . $profil['id_Pfl']) ?>" class="btn-orange">
...
<div class="show-grid">
    ...
    <!-- COL GAUCHE — Infos profil -->
    <div class="card">
        <div class="profil-hero">
            <div class="profil-hero-icon"><i class="fas fa-id-badge"></i></div>
            <div>
                <div class="profil-hero-name"><?= esc($profil['Libelle_Pfl']) ?></div>
                <div class="profil-hero-id">ID # <?= (int)$profil['id_Pfl'] ?></div>
            </div>
        </div>
        ...
        <div class="info-body">
            <div class="info-row">
                ...
                <span class="info-value" style="font-weight:600;"><?= esc($profil['Libelle_Pfl']) ?></span>
            </div>
            <div class="info-row">
                <span class="info-label">Identifiant</span>
                <span class="info-value"><?= (int)$profil['id_Pfl'] ?></span>
            </div>
            <div class="info-row">
    ...
    <div class="card">
        <div class="card-header">
            ...
            <p class="card-title">Employés avec ce profil</p>
        ...
        <div class="empty-state">
            ...
            Aucun employé n'a ce profil pour l'instant.
        </div>
        <?php else: ?>
        <table class="emp-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="color:var(--c-muted);font-size:0.75rem;"><?= esc($e['Libelle_Grd'] ?? '-') ?></td>
