...
<div class="page-header">
    <div>
        <h1><i class="fas fa-plus me-2" style="color:#F5A623;"></i>Nouveau profil</h1>
        <p>Ajouter un profil au référentiel</p>
    </div>
...
<div class="form-card">
    <div class="form-card-header">
        <div class="form-card-icon"><i class="fas fa-id-badge"></i></div>
        <div>
            <p class="form-card-title">Informations du profil</p>
            <p class="form-card-subtitle">Le libellé doit être unique</p>
        </div>
    </div>

    <form action="<?= base_url('parametres/profil/store') ?>" method="POST">
        <?= csrf_field() ?>
