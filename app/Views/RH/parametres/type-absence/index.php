...
<div class="page-header">
    <div>
        <h1><i class="fas fa-tags me-2" style="color:#F5A623;"></i>Types d'absences</h1>
        <p>Gestion des types d'absences</p>
    </div>
    <a href="<?= base_url('parametres/type-absence/create') ?>" class="btn-orange">
...
<div class="stats-row">
    ...
    <div class="stat-pill">
        <div class="stat-pill-icon" style="background:var(--c-blue-pale);border:1px solid var(--c-blue-border);">
            <i class="fas fa-user-clock" style="color:#5B9BF0;"></i>
        </div>
        <div>
            <div class="stat-pill-val" style="color:#5B9BF0;"><?= $totalAbsences ?></div>
            <div class="stat-pill-lbl">Absences associées</div>
        </div>
    </div>
    <div class="stat-pill">
...
<div class="card">
    <div class="card-header">
        <div class="card-header-left">
            ...
            <p class="card-title">Liste des types d'absences</p>
        </div>
    ...
    <table class="data-table">
        ...
        <tbody>
            ...
            <tr class="type-row"
                data-libelle="<?= strtolower(esc($t['Libelle_TAbs'])) ?>"
                data-usage="<?= $t['nb_absences'] > 0 ? 'used' : 'unused' ?>">
                <td class="row-num" style="color:var(--c-muted);font-size:0.7rem;"><?= $i + 1 ?></td>
                <td>
                    <a href="<?= base_url('parametres/type-absence/show/' . $t['id_TAbs']) ?>"
                       class="type-name"><?= esc($t['Libelle_TAbs']) ?></a>
                </td>
                <td style="text-align:center;">
                    <span class="card-count"><?= (int)$t['nb_absences'] ?></span>
                </td>
                <td>
                    <?php if ($t['nb_absences'] > 0): ?>
                ...
                <td style="text-align:center;">
                    <div style="display:inline-flex;gap:5px;">
                        ...
                        <a href="<?= base_url('parametres/type-absence/edit/' . $t['id_TAbs']) ?>"
                           class="btn-icon btn-icon-orange" title="Modifier">
                            <i class="fas fa-pen"></i>
                        </a>
                        <button class="btn-icon btn-icon-red" title="Supprimer"
                                onclick="confirmDelete(<?= $t['id_TAbs'] ?>, '<?= esc($t['Libelle_TAbs'], 'js') ?>', <?= (int)$t['nb_absences'] ?>)">
...
(function () {
    ...
    window.confirmDelete = function (id, label, nbAbsences) {
        ...
        if (nbAbsences > 0) {
            msg.innerHTML = 'Impossible de supprimer <strong style="color:#fff;">' + label
                + '</strong> : ' + nbAbsences + ' absence(s) y sont associées.';
            ...
            form.action = '<?= base_url('parametres/type-absence/delete/') ?>' + id;
        }
