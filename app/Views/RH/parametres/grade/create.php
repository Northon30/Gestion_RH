...
<div class="page-header">
    <div>
        <h1><i class="fas fa-plus me-2" style="color:#F5A623;"></i>Nouveau grade</h1>
        <p>Ajouter un grade au référentiel</p>
    </div>
...
<div class="form-card">
    <div class="form-card-header">
        <div class="form-card-icon"><i class="fas fa-medal"></i></div>
        <div>
            <p class="form-card-title">Informations du grade</p>
            <p class="form-card-subtitle">Le libellé doit être unique</p>
        </div>
    </div>

    <form action="<?= base_url('parametres/grade/store') ?>" method="POST">
        <?= csrf_field() ?>
        ...
        <div class="form-card-footer">
            ...
            <button type="submit" class="btn-orange">
                <i class="fas fa-save"></i> Créer le grade
            </button>
        </div>
    </form>
</div>
