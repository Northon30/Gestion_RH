...
<div class="page-header">
    <div>
        <h1><i class="fas fa-pen me-2" style="color:#F5A623;"></i>Modifier le grade</h1>
        <p><?= esc($grade['Libelle_Grd']) ?></p>
    </div>
    <a href="<?= base_url('parametres/grade/show/' . $grade['id_Grd']) ?>" class="btn-ghost">
    ...
    <div class="form-card-header">
        <div class="form-card-header-left">
            ...
            <div>
                ...
                <p class="form-card-subtitle">Grade ID # <?= (int)$grade['id_Grd'] ?></p>
            </div>
        </div>
        <span class="badge-id"># <?= (int)$grade['id_Grd'] ?></span>
    </div>

    <form action="<?= base_url('parametres/grade/update/' . $grade['id_Grd']) ?>" method="POST">
        <?= csrf_field() ?>
        ...
        <div class="form-card-body">
            ...
            <div class="current-val">
                ...
                Valeur actuelle : <span><?= esc($grade['Libelle_Grd']) ?></span>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" name="Libelle_Grd" id="f-libelle"
                       class="form-control" maxlength="100"
                       value="<?= old('Libelle_Grd', esc($grade['Libelle_Grd'])) ?>"
