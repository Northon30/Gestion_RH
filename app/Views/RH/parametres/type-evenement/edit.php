...
<div class="page-header">
    <div>
        <h1><i class="fas fa-pen me-2" style="color:#F5A623;"></i>Modifier le type d'événement</h1>
        <p><?= esc($type['Libelle_Tev']) ?></p>
    </div>
    <a href="<?= base_url('parametres/type-evenement/show/' . $type['id_Tev']) ?>" class="btn-ghost">
    ...
    <div class="form-card-header">
        <div class="form-card-header-left">
            ...
            <div>
                ...
                <p class="form-card-subtitle">Type événement ID # <?= (int)$type['id_Tev'] ?></p>
            </div>
        </div>
        <span class="badge-id"># <?= (int)$type['id_Tev'] ?></span>
    </div>

    <form action="<?= base_url('parametres/type-evenement/update/' . $type['id_Tev']) ?>" method="POST">
        <?= csrf_field() ?>
        ...
        <div class="form-card-body">
            ...
            <div class="current-val">
                ...
                Valeur actuelle : <span><?= esc($type['Libelle_Tev']) ?></span>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" name="Libelle_Tev" id="f-libelle"
                       ...
                       value="<?= old('Libelle_Tev', esc($type['Libelle_Tev'])) ?>"
