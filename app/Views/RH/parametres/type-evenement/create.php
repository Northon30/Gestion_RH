...
<div class="page-header">
    <div>
        <h1><i class="fas fa-plus me-2" style="color:#F5A623;"></i>Nouveau type d'événement</h1>
        <p>Ajouter un type d'événement au référentiel</p>
    </div>
...
<div class="form-card">
    <div class="form-card-header">
        ...
        <div>
            <p class="form-card-title">Nouveau type d'événement</p>
            <p class="form-card-subtitle">Ce type sera disponible à la création d'un événement</p>
        </div>
    </div>

    <form action="<?= base_url('parametres/type-evenement/store') ?>" method="POST">
        <?= csrf_field() ?>

        <div class="form-card-body">
            <div class="form-group">
                <label class="form-label">
                    Libellé <span class="req">*</span>
                </label>
                <input type="text" name="Libelle_Tev" id="f-libelle"
                       class="form-control" maxlength="100"
                       value="<?= old('Libelle_Tev') ?>"
                       placeholder="Ex : Réunion, Séminaire, Anniversaire..."
            ...
            <p class="form-hint">
                <i class="fas fa-info-circle" style="color:var(--c-orange);"></i>
                Le libellé doit être unique et compris entre 2 et 100 caractères.
            </p>
        </div>
