...
<nav class="top-navbar">
    ...
    <div class="navbar-title">
        <i class="fas fa-chevron-right me-2" style="color:#F5A623;font-size:0.7rem;"></i>
            ...
            <div class="notif-dropdown" id="notifDropdown">
                ...
                <div class="nd-header">
                    <div style="display:flex;align-items:center;gap:8px;">
                        <i class="fas fa-bell" style="color:#F5A623;"></i>
                ...
                <div class="nd-footer">
                    <a href="<?= base_url('notifications') ?>">
                        ...
                        <?php if ($nonLues > 0): ?>
                        <span class="badge-orange ms-1"><?= $nonLues ?></span>
                        <?php endif; ?>
                    </a>
                </div>
        ...
        <div class="user-wrapper" id="userWrapper">
            ...
            <div class="user-dropdown" id="userDropdown">
                ...
                <a href="<?= base_url('notifications') ?>" class="ud-item">
                    ...
                    <?php if ($nonLues > 0): ?>
                    <span class="badge-orange ms-auto"><?= $nonLues ?></span>
                    <?php endif; ?>
                </a>
                <div class="ud-divider"></div>
...
.nd-read-all:hover { color: #F5A623; }
...
.nd-item.unread          { background: rgba(245,166,35,0.04); }
.nd-item.unread:hover    { background: rgba(245,166,35,0.08); }
...
.nd-footer a:hover { color: #F5A623; }
...
/* Mini profil en haut du dropdown */
.ud-profile {
    display: flex;
    align-items: center;
    gap: 10px;
...
// ── Lire une notification + redirection ───────────────────────
...
function marquerToutesLues() {
    fetch('<?= base_url('notifications/lire-toutes') ?>', {
        ...
        document.querySelectorAll('.nd-item.unread').forEach(el => {
