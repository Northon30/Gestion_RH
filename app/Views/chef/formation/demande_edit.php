...
<style>
    ...
    .form-section-head {
        padding: 10px 16px; background: var(--c-primary-pale);
        border-bottom: 1px solid var(--c-border);
        display: flex; align-items: center; gap: 8px;
        color: var(--c-accent); font-size: 0.78rem; font-weight: 700;
    ...
    .type-opt:hover    { border-color: var(--c-primary-border); }
    .type-opt.selected { border-color: var(--c-primary-border); background: var(--c-primary-pale); }
    ...
    .type-opt.selected .type-opt-label { color: var(--c-accent); }
    ...
    .source-opt:hover    { border-color: var(--c-primary-border); }
    .source-opt.selected { border-color: var(--c-primary-border); background: var(--c-primary-pale); }
    ...
    .source-opt.selected .source-opt-label { color: var(--c-accent); }
...
<div class="page-header">
    <div>
        <h1><i class="fas fa-pen me-2" style="color:#3A7BD5;"></i>Modifier la demande</h1>
...
(function () {
    ...
    window.previewFormation = function () {
        ...
        placesEl.style.color = restants <= 0 ? '#ff8080' : (restants <= 3 ? '#ffc107' : '#90c97f');
        prev.classList.add('visible');
    };

    // Preview au chargement si formation sélectionnée
    var sel = document.getElementById('sel-formation');
