...
<style>
    ...
    .fiche-avatar.male   { background: var(--c-primary-pale); color: var(--c-accent); border-color: var(--c-primary-border); }
    ...
    .mc-grade     { background: var(--c-primary-pale); border: 1px solid var(--c-primary-border); color: var(--c-accent); }
    .mc-profil    { background: rgba(139,92,246,0.10); border: 1px solid rgba(139,92,246,0.25);   color: #a78bfa; }
    .mc-matricule { background: var(--c-primary-pale); border: 1px solid var(--c-primary-border); color: var(--c-accent); }
    ...
    /* Actions : seulement Imprimer + Retour pour le chef */
    ...
    .info-value.highlight { color: var(--c-accent); font-weight: 700; }
    ...
    .solde-card:hover { border-color: var(--c-primary-border); }

    .solde-val   { font-size: 1.8rem; font-weight: 900; color: var(--c-accent); line-height: 1; }
    ...
    .data-table tbody tr:hover td { background: rgba(58,123,213,0.02); }
    ...
    .empty-tab-icon {
        ...
        display: flex; align-items: center; justify-content: center;
        font-size: 1.1rem; color: var(--c-accent); margin: 0 auto 12px;
    }
    ...
    @media print {
        * { box-sizing: border-box; }
        html, body { width: 100% !important; margin: 0 !important; padding: 0 !important; background: #fff !important; color: #111 !important; font-family: 'Segoe UI', Arial, sans-serif !important; }
        #sidebar, .sidebar, [class*="sidebar"], #navbar, .navbar, nav, .tabs-nav, .fiche-actions, #btn-print, .btn-outline, .btn-blue { display: none !important; }
        .main-content, #main-content, main { width: 100% !important; max-width: 100% !important; margin: 0 !important; padding: 8mm 12mm !important; }
        .print-only { display: flex !important; }
        .print-header { display: flex !important; align-items: center; justify-content: space-between; margin-bottom: 14px; padding-bottom: 10px; border-bottom: 2px solid #3A7BD5; }
        .print-header-logo { font-size: 1rem; font-weight: 800; color: #3A7BD5 !important; -webkit-print-color-adjust: exact; print-color-adjust: exact; }
        .print-header-info { font-size: 0.72rem; color: #666; text-align: right; }
        .tab-panel { display: block !important; page-break-inside: avoid; }
        .print-section-title { display: block !important; font-size: 0.75rem; font-weight: 800; color: #3A7BD5 !important; text-transform: uppercase; letter-spacing: 0.8px; margin: 16px 0 8px; padding-bottom: 5px; border-bottom: 1px solid #3A7BD5; -webkit-print-color-adjust: exact; print-color-adjust: exact; }
        ...
        .info-value.highlight { color: #3A7BD5 !important; -webkit-print-color-adjust: exact; print-color-adjust: exact; }
        .data-table thead th { background: #e8f0fb !important; color: #111 !important; border-bottom: 1px solid #3A7BD5 !important; -webkit-print-color-adjust: exact; print-color-adjust: exact; }
        .data-table tbody td { color: #333 !important; border-color: #eee !important; }
        .solde-card { background: #f9f9f9 !important; border: 1px solid #ddd !important; }
        .solde-val { color: #3A7BD5 !important; -webkit-print-color-adjust: exact; print-color-adjust: exact; }
        .anciennete-fill { background: #3A7BD5 !important; -webkit-print-color-adjust: exact; print-color-adjust: exact; }
...
<div class="fiche-header">
    ...
    <!-- Chef : Imprimer + Retour uniquement (pas de bouton Modifier) -->
    ...
    <div class="card-dark">
        ...
        <table class="data-table">
            ...
            <tbody>
                ...
                <tr>
                    <td>
                        <span style="color:var(--c-accent);font-weight:600;font-size:0.8rem;
...
<div class="tab-panel" id="tab-competences">
    ...
    <div class="card-dark">
        <div class="card-dark-title">
            ...
            <span style="background:var(--c-primary-pale);border:1px solid var(--c-primary-border);
        ...
        <div class="competences-wrap">
            ...
            <span class="competence-tag">
                ...
                <span style="font-size:0.62rem;color:rgba(91,155,240,0.7);margin-left:2px;" title="Obtenue via formation : <?= esc($comp['Titre_Frm']) ?>">
