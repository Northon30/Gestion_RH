...
<style>
    ...
    .card-count {
        background:var(--e-primary-pale); border:1px solid var(--e-primary-border);
        color:var(--e-primary); font-size:0.68rem; font-weight:700;
    ...
    .notif-item.unread      { background:rgba(107,175,107,0.04); }
    .notif-item.unread:hover{ background:rgba(107,175,107,0.07); }
    ...
    .notif-dot {
        width:7px; height:7px; background:var(--e-primary);
    ...
    .btn-icon-primary { background:var(--e-primary-pale); color:var(--e-primary); border:1px solid var(--e-primary-border); }
...
<div class="page-header">
    <div>
        <h1><i class="fas fa-bell me-2" style="color:var(--e-primary);"></i>Notifications</h1>
...
<div class="stats-row">
    <div class="stat-pill">
        <div class="stat-pill-icon" style="background:var(--e-primary-pale);border:1px solid var(--e-primary-border);">
            <i class="fas fa-bell" style="color:var(--e-primary);"></i>
        </div>
        <div>
...
<div class="card">
    <div class="card-header">
        <div class="card-header-left">
            ...
            <p class="card-title">Mes notifications</p>
        </div>
...
(function () {
    ...
    window.marquerLue = function (id) {
        fetch('<?= base_url('notifications/lire/') ?>' + id, {
            ...
            var btns = item.querySelectorAll('.btn-icon-primary');
