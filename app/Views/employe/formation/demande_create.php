...
<div class="page-header">
    <div>
        <h1><i class="fas fa-file-alt me-2" style="color:var(--e-primary);"></i>Nouvelle demande de formation</h1>
...
<div class="form-card">
    <div class="form-card-header">
        ...
        <div>
            ...
            <p class="form-card-subtitle">Tous les champs marqués <span style="color:var(--e-primary);">*</span> sont obligatoires</p>
        </div>
    </div>
